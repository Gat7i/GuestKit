...
export default function SuggestionGallery({ images }: SuggestionGalleryProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="relative aspect-video bg-gray-100 rounded-lg overflow-hidden">
        <img
          ...
          alt={currentImage.image.alt_text || 'Photo de l\'activité'}
        ...
        {currentImage.is_principal && (
          <div className="absolute top-4 left-4">
            <span className="bg-purple-500 text-white px-3 py-1.5 rounded-full text-xs font-medium shadow-lg flex items-center gap-1">
        ...
        <div className="grid grid-cols-6 gap-2">
          {sortedImages.map((img, idx) => (
            ...
            >
              ...
              />
              {img.is_principal && (
                <div className="absolute top-1 right-1 w-4 h-4 bg-purple-500 rounded-full flex items-center justify-center text-white text-[10px]">
                  ⭐
                </div>
              )}
            </button>
